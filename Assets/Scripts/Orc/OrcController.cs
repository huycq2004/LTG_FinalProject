...
public class OrcController : MonoBehaviour
{
    ...
    void HandleMovement()
    {
        ...
        if (player != null)
        {
            // Tính khoảng cách giữa Orc và Player
    ...
    void ChasePlayer()
    {
        // Tính hướng từ Orc đến Player (1 = Player bên phải, -1 = Player bên trái)
    ...
    void TryAttack()
    {
        ...
        // Kiểm tra có thể tấn công không (không đang tấn công và animator sẵn sàng)
    ...
    void DealDamage()
    {
        ...
        if (hitPlayer != null)
        {
            Debug.Log("Orc đánh trúng Player: " + hitPlayer.name);

            // Tính hướng knockback từ Orc đến Player (để đẩy Player ra)
    ...
    void DisableEnemyCollisions()
    {
        ...
        foreach (OrcController otherOrc in allOrcs)
        {
            ...
            if (otherOrc != this)
            {
                ...
                if (otherCollider != null && orcCollider != null)
    ...
    public void TakeDamage(int damage)
    {
        ...
        Debug.Log("Orc nhận " + damage + " sát thương");
        
        // Trừ máu
        currentHealth -= damage;
        Debug.Log("Orc còn " + currentHealth + " máu");
    ...
    void Die()
    {
        ...
        // Set animation isDeath cho Animator
        if (animator != null)
